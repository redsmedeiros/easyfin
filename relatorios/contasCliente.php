...
<body>
	...
	<div class="mx-2" style="padding-top:15px ">
		...
		<div class="mb-2 mx-2 " align="right"><small><small><b>Cliente:</b> <?php echo $nome_cliente ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Telefone:</b> <?php echo $telefone_cliente ?></small></small></div>
...
<div class="cabecalho mt-3" style="border-bottom: solid 1px #0340a3">
		...
		<div class="linha-cab p-2">
				...
				<div class="coluna text-danger" style="width:25%">PENDENTES: R$ <?php echo @$total_pendentesF ?>  </div>
				<div class="coluna <?php echo $classe_saldo ?>" style="width:25%">TOTAL: R$ <?php echo @$total_saldoF ?>  </div>
			</div>
		<?php }else{ ?>
