...
if($id == ""){
	...
	$query = $pdo->prepare("INSERT INTO $pagina set descricao = :campo1, cliente = :campo2, entrada = :campo3, documento = :campo4, plano_conta = :campo5, data_emissao = :campo6, vencimento = :campo7, frequencia = :campo8, valor = :campo9, usuario_lanc = :campo10, status = 'Pendente', data_recor = curDate(), arquivo = '$imagem'");
	...
	if (@$_FILES['imagem']['name'] == ""){
		...
		$query = $pdo->prepare("UPDATE $pagina set descricao = :campo1, cliente = :campo2, entrada = :campo3, documento = :campo4, plano_conta = :campo5, data_emissao = :campo6, vencimento = :campo7, frequencia = :campo8, valor = :campo9, usuario_lanc = :campo10, arquivo = '$imagem' WHERE id = '$id'");
