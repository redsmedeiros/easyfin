...
echo '<a style="text-decoration:none" class="text-danger ml-2" href="#" onclick="ModalFecharVenda()" title="Esc ou F4 para Fechar Compra"><i class="bi bi-cash"></i> <small>(f4) Fechar Compra R$</small> </a></div>';
